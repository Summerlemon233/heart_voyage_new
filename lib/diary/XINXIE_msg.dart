...
class XINXIE_msg extends StatefulWidget {
  const XINXIE_msg({super.key});

  @override
  State<XINXIE_msg> createState() => _XINXIE_msgState();
}

class _XINXIE_msgState extends State<XINXIE_msg> {
