...
class ZHENGNIAN_scan extends StatefulWidget {
  const ZHENGNIAN_scan({Key? key}) : super(key: key);

  @override
  ZHENGNIAN_scanState createState() => ZHENGNIAN_scanState();
}

class ZHENGNIAN_scanState extends State<ZHENGNIAN_scan> with WidgetsBindingObserver {
  late Timer _timer;
    ...
    if (kIsWeb ||
      ...
      ClippingAudioSource(
        child: AudioSource.asset(
            'assets/audio/ZHENGNIAN_scan.mp3'),
        tag: AudioMetadata(
          album: "身体扫描",
          title: "正念",
          artwork:
                  ...
                  return Column(
                    ...
                    children: [
                      Container(
                        ...
                        child:Image.asset("assets/images/body_scan_album.jpeg",fit: BoxFit.cover,),
