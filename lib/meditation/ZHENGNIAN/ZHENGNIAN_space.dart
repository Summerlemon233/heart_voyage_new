...
class ZHENGNIAN_space extends StatefulWidget {
  const ZHENGNIAN_space({Key? key}) : super(key: key);

  @override
  ZHENGNIAN_spaceState createState() => ZHENGNIAN_spaceState();
}
...
class ZHENGNIAN_spaceState extends State<ZHENGNIAN_space> with WidgetsBindingObserver {
  ...
  final _playlist = ConcatenatingAudioSource(children: [
    ...
    if (kIsWeb ||
      ...
      ClippingAudioSource(
        child: AudioSource.asset('assets/audio/ZHENGNIAN_space.mp3'),
        tag: AudioMetadata(
          album: "三步呼吸空间",
          title: "正念",
          artwork:
