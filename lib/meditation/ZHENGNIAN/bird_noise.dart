...
class bird_noise extends StatefulWidget {
  const bird_noise({Key? key}) : super(key: key);

  @override
  bird_noiseState createState() => bird_noiseState();
}

class bird_noiseState extends State<bird_noise> with WidgetsBindingObserver {
  late Timer _timer;
  ...
  final _playlist = ConcatenatingAudioSource(children: [
    ...
    if (kIsWeb ||
      ...
      ClippingAudioSource(
        child: AudioSource.asset('assets/audio/bird_noise.mp3'),
        tag: AudioMetadata(
          album: "鸟鸣与森林之风",
          title: "白噪音",
          artwork:
                  ...
                  return Column(
                    ...
                    children: [
                      Container(
                        ...
                        child:Image.asset("assets/images/bird.jpg",fit: BoxFit.cover,),
