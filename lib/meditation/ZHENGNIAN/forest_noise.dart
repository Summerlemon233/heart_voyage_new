...
class forest_noise extends StatefulWidget {
  const forest_noise({Key? key}) : super(key: key);

  @override
  forest_noiseState createState() => forest_noiseState();
}

class forest_noiseState extends State<forest_noise> with WidgetsBindingObserver {
  late Timer _timer;
  ...
  final _playlist = ConcatenatingAudioSource(children: [
    ...
    if (kIsWeb ||
      ...
      ClippingAudioSource(
        child: AudioSource.asset('assets/audio/forest_noise.mp3'),
        tag: AudioMetadata(
          album: "森林实地录音",
          title: "白噪音",
          artwork:
