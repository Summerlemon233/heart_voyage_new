...
class insect_noise extends StatefulWidget {
  const insect_noise({Key? key}) : super(key: key);

  @override
  insect_noiseState createState() => insect_noiseState();
}

class insect_noiseState extends State<insect_noise> with WidgetsBindingObserver {
  late Timer _timer;
  ...
  final _playlist = ConcatenatingAudioSource(children: [
    ...
    if (kIsWeb ||
      ...
      ClippingAudioSource(
        child: AudioSource.asset('assets/audio/insect_noise.mp3'),
        tag: AudioMetadata(
          album: "乡间虫鸣",
          title: "白噪音",
          artwork:
                  ...
                  return Column(
                    ...
                    children: [
                      Container(
                        ...
                        child:Image.asset("assets/images/insect.jpg",fit: BoxFit.cover,),
