...
class night_noise extends StatefulWidget {
  const night_noise({Key? key}) : super(key: key);

  @override
  night_noiseState createState() => night_noiseState();
}

class night_noiseState extends State<night_noise> with WidgetsBindingObserver {
  late Timer _timer;
  ...
  final _playlist = ConcatenatingAudioSource(children: [
    ...
    if (kIsWeb ||
      ...
      ClippingAudioSource(
        child: AudioSource.asset('assets/audio/night_noise.mp3'),
        tag: AudioMetadata(
          album: "夜晚",
          title: "白噪音",
          artwork:
                  ...
                  return Column(
                    ...
                    children: [
                      Container(
                        ...
                        child:Image.asset("assets/images/night.jpg",fit: BoxFit.cover,),
