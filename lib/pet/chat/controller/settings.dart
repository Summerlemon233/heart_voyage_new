...
import '../data/secret.dart';
import '../utils/package.dart';

class SettingsController extends GetxController {
  final isObscure = true.obs;
  final openAiKey = Default_API.obs;
  final youCode = "".obs;

  final openAiBaseUrl = Default_URL.obs;
  ...
  getOpenAiKeyFromPreferences() async {
    GetStorage _box = GetStorage();
    String key = _box.read('openAiKey') ?? Default_API;
    setOpenAiKey(key);
  }
  ...
  getOpenAiBaseUrlFromPreferences() async {
    GetStorage _box = GetStorage();
    String baseUrl = _box.read('openAiBaseUrl') ?? "https://www.heartvoyage.live";
